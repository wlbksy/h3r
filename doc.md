...
1. Deside a coordinate C (lat, lng) for your application in which C is the center point of your area of interest.
2. Deside an angle (noted as z) you would like the generated grids to rotate around your selected corrdinate C. This angle could be selected through visualization trials.
3. Apply rotation and begin your search.

# example

Suppose we have choosen C (lat, lng) and rotation angle z, both in degree.
