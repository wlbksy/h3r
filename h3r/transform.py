...
from .geopoint import GeoLatLng, GeoXYZ
...
class hexagon:
    def __init__(self):
        ...
        self.h3_face_5 = GeoLatLng(
            9.897578191520505, 96.15073392959359, using_rad=False)
    ...
    def __reset_by_centroid_and_azimuth(self, centroid: GeoLatLng, azimuth: float):
        x_angle = centroid.lat_rad - self.h3_face_5.lat_rad
        z_angle = centroid.lng_rad - self.h3_face_5.lng_rad

        R = rotation_axis_angle(centroid, azimuth) @ rotation3D_z(
            z_angle) @ rotation3D_x(x_angle)
